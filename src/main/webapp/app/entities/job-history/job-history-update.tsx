  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField label="Language" id="job-history-language" name="language" data-cy="language" type="select">
              ...
              <ValidatedField id="job-history-job" name="job" data-cy="job" label="Job" type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField id="job-history-department" name="department" data-cy="department" label="Department" type="select">
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField id="job-history-employee" name="employee" data-cy="employee" label="Employee" type="select">
                <option value="" key="0" />
                {employees
