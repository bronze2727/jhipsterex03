  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Region Name" id="region-regionName" name="regionName" data-cy="regionName" type="text" />
