...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Filtrele (Önek ile)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Önek</th>
            <th onClick={changeReverseProperties}>Özellikler</th>
          </tr>
        </thead>
        <tbody>
