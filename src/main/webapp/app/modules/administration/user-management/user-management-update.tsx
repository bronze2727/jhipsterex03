            ...
            <ValidatedForm onSubmit={saveUser} defaultValues={user}>
              ...
              <ValidatedField
                ...
                validate={{
                  required: {
                    value: true,
                    message: 'E-posta zorunlu alandır.',
                  },
                  minLength: {
                    value: 5,
                    message: 'E-posta adresi en az 5 karakter olmalıdır',
                  },
                  maxLength: {
                    value: 254,
                    message: 'E-posta adresi 50 karakterden fazla olamaz',
                  },
              ...
              <ValidatedField type="select" name="authorities" multiple label="Profiller">
