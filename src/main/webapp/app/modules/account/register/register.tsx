        ...
        <Col md="8">
          <ValidatedForm id="register-form" onSubmit={handleValidSubmit}>
            ...
            <ValidatedField
              ...
              type="email"
              validate={{
                required: { value: true, message: 'E-posta zorunlu alandır.' },
                minLength: { value: 5, message: 'E-posta adresi en az 5 karakter olmalıdır' },
                maxLength: { value: 254, message: 'E-posta adresi 50 karakterden fazla olamaz' },
                validate: v => isEmail(v) || 'E-posta alanı uygun değil.',
              }}
              data-cy="email"
            />
            <ValidatedField
            ...
            <ValidatedField
              ...
              type="password"
              validate={{
                required: { value: true, message: 'Tekrar şifresi zorunludur.' },
                minLength: { value: 4, message: 'Tekrar şifreniz en az 4 karakter olmalıdır' },
                maxLength: { value: 50, message: 'Tekrar şifreniz 50 karakterden uzun olamaz' },
          ...
          <Alert color="warning">
            <span></span>
            <a className="alert-link">Giriş</a>
            <span>
